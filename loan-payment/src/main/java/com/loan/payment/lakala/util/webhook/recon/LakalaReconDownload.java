package com.loan.payment.lakala.util.webhook.recon;


import com.loan.payment.lakala.util.webhook.WebHookHandler;
import com.loan_entity.lakala.notify.ReconDownload;
...
@Controller
public class LakalaReconDownload {

    private static final Logger logger = LoggerFactory.getLogger(LakalaReconDownload.class);
